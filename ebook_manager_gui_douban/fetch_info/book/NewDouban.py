...
from book.Metadata import Metadata, MetaSourceInfo, MetaRecord

from book.search_metadata import meta
from flask import request, Response
from book import helper
...
DOUBAN_BOOK_CACHE_SIZE = 10  # 最大缓存数量
DOUBAN_CONCURRENCY_SIZE = 1  # 并发查询数
