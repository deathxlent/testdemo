var App = (function () {
    ...
    function initEls() {
        els = {
            ...
            batchTool: document.getElementById('batchTool'),
            batchProcessSection: document.getElementById('batchProcessSection'),
            batchAddFiles: document.getElementById('batchAddFiles'),
            batchClearFiles: document.getElementById('batchClearFiles'),
            batchAddFromEditor: document.getElementById('batchAddFromEditor'),
            batchFileCount: document.getElementById('batchFileCount'),
            batchFileList: document.getElementById('batchFileList'),
            batchAddOperation: document.getElementById('batchAddOperation'),
            batchOperationList: document.getElementById('batchOperationList'),
            batchOutputFormat: document.getElementById('batchOutputFormat'),
            batchOutputDir: document.getElementById('batchOutputDir'),
            batchConflictMode: document.getElementById('batchConflictMode'),
            batchStartProcess: document.getElementById('batchStartProcess'),
            batchProgressOverlay: document.getElementById('batchProgressOverlay'),
            batchProgressClose: document.getElementById('batchProgressClose'),
            batchCurrentFile: document.getElementById('batchCurrentFile'),
            batchProgressBar: document.getElementById('batchProgressBar'),
            batchProgressText: document.getElementById('batchProgressText'),
            batchPauseBtn: document.getElementById('batchPauseBtn'),
            batchCancelBtn: document.getElementById('batchCancelBtn'),
            puzzleTool: document.getElementById('puzzleTool'),
            puzzlePropsSection: document.getElementById('puzzlePropsSection'),
            puzzleCanvasWidth: document.getElementById('puzzleCanvasWidth'),
            puzzleCanvasHeight: document.getElementById('puzzleCanvasHeight'),
            puzzleApplyCanvas: document.getElementById('puzzleApplyCanvas'),
            puzzleTemplateList: document.getElementById('puzzleTemplateList'),
            puzzleGap: document.getElementById('puzzleGap'),
            puzzleGapColor: document.getElementById('puzzleGapColor'),
            puzzleExport: document.getElementById('puzzleExport'),
            puzzleExit: document.getElementById('puzzleExit'),
            puzzleLayer: document.getElementById('puzzleLayer'),
            puzzleCustomSettings: document.getElementById('puzzleCustomSettings'),
            puzzleCustomCols: document.getElementById('puzzleCustomCols'),
            puzzleCustomRows: document.getElementById('puzzleCustomRows'),
            puzzleCellRatio: document.getElementById('puzzleCellRatio'),
            puzzleApplyCustom: document.getElementById('puzzleApplyCustom'),
            puzzleBorderRadius: document.getElementById('puzzleBorderRadius'),
            puzzleShadowEnabled: document.getElementById('puzzleShadowEnabled'),
            puzzleShadowSettings: document.getElementById('puzzleShadowSettings'),
            puzzleShadowColor: document.getElementById('puzzleShadowColor'),
            puzzleShadowBlur: document.getElementById('puzzleShadowBlur'),
            puzzleBgUpload: document.getElementById('puzzleBgUpload'),
            puzzleImageModal: document.getElementById('puzzleImageModal'),
            puzzleImageModalClose: document.getElementById('puzzleImageModalClose'),
            puzzleEditorFrame: document.getElementById('puzzleEditorFrame'),
            puzzleEditorCrop: document.getElementById('puzzleEditorCrop'),
            puzzleImgRotate: document.getElementById('puzzleImgRotate'),
            puzzleImgFlipV: document.getElementById('puzzleImgFlipV'),
            puzzleImgFlipH: document.getElementById('puzzleImgFlipH'),
            puzzleImgReplace: document.getElementById('puzzleImgReplace'),
            puzzleImgSave: document.getElementById('puzzleImgSave'),
            ...
            zoomInfoBtn: document.getElementById('zoomInfoBtn'),
    ...
    function deactivateAllImgTools() {
        ...
        else if (state.activeImgTool === 'batch' && App.BatchProcess) App.BatchProcess.deactivate();
        else if (state.activeImgTool === 'puzzle' && App.Puzzle) App.Puzzle.deactivate();
